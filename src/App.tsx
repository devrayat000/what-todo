...
function App() {
  return (
    <div className="h-screen bg-light-gray dark:bg-dark-blue">
      <div className="prose max-w-none prose-img:my-0 px-6 pt-12 pb-24 bg-[url('/images/bg-mobile-light.jpg')] dark:bg-[url('/images/bg-mobile-dark.jpg')] md:bg-[url('/images/bg-desktop-light.jpg')] dark:md:bg-[url('/images/bg-desktop-dark.jpg')] bg-cover">
